...
parser.add_argument("--model_path", default="path_to_your_checkpoints", type=str, help="model_path")
parser.add_argument("--backbone", default='vit_base_patch16_224', type=str, help="vit_base_patch16_224")
parser.add_argument("--pooling", default='gmp', type=str, help="pooling choice for patch tokens")
parser.add_argument("--img_folder", default='path_to_your_folder', type=str, help="dataset folder")
...
parser.add_argument("--master_port", default=29502, type=int, help="master_port")
parser.add_argument("--nproc_per_node", default=1, type=int, help="nproc_per_node")
...
def _validate(pid, model=None, dataset=None, args=None):
    ...
    print(format_tabs_multi_metircs([seg_score], ["confusion","precision","recall",'iou'], cat_list=coco.class_list))
