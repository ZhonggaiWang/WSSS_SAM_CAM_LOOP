...
from model.double_seg_head import network_CL
...
parser.add_argument("--model_path", default="/home/zhonggai/python-work-space/ToCo-B_WSSS_work/CVPR_wsss_baseline/scripts/work_dir_voc_wseg/GT_Refinement_CAM/checkpoints/model_iter_8000.pth", type=str, help="model_path")
